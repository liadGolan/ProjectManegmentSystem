            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">{{$task->name}}</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="/viewDeliverable/{{$data['id']}}/task/{{$task->id}}/">
        ...
        <div class="col-xl-12 col-sm-12 mb-3 text-center">
          ...
          <div class="card mb-3">
            <div class="card-header text-center">
              <i class="fa fa-bell-o"></i>Issues, if any:
            </div>
