    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-6 col-sm-6 mb-3">
            ...
            <br />
            {{Form::select('deliverable', $deliverables_array,null, array('class' => 'custom-select'))}}
            <br />
            <br />
          </div>
          <div class="col-xl-6 col-sm-6 mb-3">
            Expected Start Date
            <br />
            {{Form::date('expected_start_date', \Carbon\Carbon::now(), array('class' => 'form-control'))}}
            <br />
            <br />
            Expected End Date
            <br />
            {{Form::date('expected_end_date',\Carbon\Carbon::now(), array('class' => 'form-control'))}}
            <br />
            <br />
            Resource Assigned To
            <br />
            {{Form::select('resource', $resource_array,null, array('class' => 'custom-select'))}}
        </div>
      </div>
      <div class="row">
        <div class="col-xl-12 col-sm-12 mb-3 text-center">
